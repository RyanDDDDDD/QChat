    ...
    ui(new Ui::AuthenFriend),_label_point(2,6)
{
    ...
    this->setModal(true);
    ui->lb_ed->setPlaceholderText("Search, add tag");
    ...
    _tip_data = { "Friend","Family","C++ Primer","Rust Programming" };

    connect(ui->more_lb, &ClickedOnceLabel::clicked, this, &AuthenFriend::ShowMoreLabel);
    InitTipLbs();

    connect(ui->lb_ed, &CustomizedEdit::returnPressed, this, &AuthenFriend::SlotLabelEnter);
    connect(ui->lb_ed, &CustomizedEdit::textChanged, this, &AuthenFriend::SlotLabelTextChange);
    connect(ui->lb_ed, &CustomizedEdit::editingFinished, this, &AuthenFriend::SlotLabelEditFinished);
...
void AuthenFriend::SlotChangeFriendLabelByTip(QString lbtext, ClickedState state)
{
